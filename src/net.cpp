...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kibocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"kibocointools.com", "35.189.5.169"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"kibocointools.com", "testnet-seed.kibocointoools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kibocoin is probably already running."), addrBind.ToString().c_str());
        else
